...
[View Cooling Air Duct Documentation →](cooling-air-ducts.md)
...
[View TPU Corner Pad Documentation →](rfsoc-4x2-corner-pads.md)
...
[View RF Pathway Documentation →](rfsoc-4x2-rf-pathway.md)

!!! note "Documentation in progress"
    The Cooling Air Ducts, TPU Corner Pads, and RF Pathway subpages are still being migrated to this site.
