...
Traditional metallic mounting structures can introduce additional reflections and scattering near an antenna, potentially impacting measurements through multipath effects. To mitigate this concern, the mount was designed using dielectric materials rather than metal structural components.
...
!!! note "Documentation in progress"
    The print settings and bill of materials subpages are still being migrated to this site.
...
Detailed testing documentation is available in [Water Immersion Test](Testing/Water_Immersion_Test.md).

!!! note "Documentation in progress"
    The full water immersion test writeup is still being migrated to this site.
...
*Manufacturing drawing of the Top Lid × Cylindrical Housing assembly, including exploded view, cross-sectional view, and bill of materials.*
...
Mechanical design, fabrication, testing, and documentation: **Joshua D'Addario**